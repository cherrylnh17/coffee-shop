...
<main class="min-h-screen p-4 sm:p-6 lg:p-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <p class="text-xs font-bold text-blue-500 uppercase tracking-widest">Konfirmasi Cetak</p>
                <h1 class="text-xl font-extrabold text-gray-900">Print Tiket Dapur</h1>
                <span class="text-xs text-gray-400">#<?= htmlspecialchars($order['code']) ?></span>
            </div>
        </div>

        <p class="text-sm text-gray-500 mb-6">
            Pastikan printer thermal menyala &amp; terhubung di sidebar sebelum menekan tombol print.
        </p>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 space-y-3">
                    ...
                    <form action="<?= BASE_URL ?>kasir/dashboard/print_kitchen" method="POST" id="print-form">
                        ...
                        <button type="submit" id="btn-print"
                            class="w-full flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 active:scale-[.98] text-white font-bold text-base py-4 rounded-xl shadow-md shadow-blue-200 transition-all">
