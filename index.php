...
<body class="font-sans text-stone-800 antialiased bg-stone-50 selection:bg-stone-500 selection:text-white">
    ...
    <header class="relative min-h-screen flex items-center justify-center hero-bg overflow-hidden">
        ...
        <div class="absolute inset-0 bg-linear-to-b from-black/70 via-black/50 to-stone-900/90 z-0"></div>

        <!-- Content -->
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
            
            <!-- Small Intro -->
            <p class="text-amber-500 font-medium tracking-[0.2em] uppercase text-sm mb-4">
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white leading-tight mb-6">
                ...
                <span class="text-transparent bg-clip-text bg-linear-to-r from-amber-400 to-amber-600 italic pr-2">
                    Träffa Coffee
                </span>
            </h1>

            <!-- Subheading -->
            <p class="text-gray-300 text-base md:text-lg lg:text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                ...
                <a href="auth/login" class="w-full sm:w-auto px-8 py-3.5 rounded-full bg-white/10 text-white font-medium border border-white/20 hover:bg-white hover:text-stone-900 transition-all duration-300 backdrop-blur-sm flex items-center justify-center gap-2">
